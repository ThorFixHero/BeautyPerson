...
- (void)adjustFrames
{
    ...
    if (self.imageview.image) {
        ...
        if (kIsFullWidthForLandScape) {
            CGFloat ratio1 = frame.size.width/imageFrame.size.width;
            imageFrame.size.height = imageFrame.size.height*ratio1;
            ...
            if (frame.size.width<=frame.size.height) {
                ...
                CGFloat ratio1 = frame.size.height/imageFrame.size.height;
                imageFrame.size.width = imageFrame.size.width*ratio1;
